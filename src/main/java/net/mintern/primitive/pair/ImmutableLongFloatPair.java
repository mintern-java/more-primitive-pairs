...
/**
 * An immutable pair consisting of a {@code long} element and an {@code float} element, providing a
 * version of {@link ImmutablePair} that avoids unnecessary {@code Long} and {@code Float} boxing.
 * <p>
...
public final class ImmutableLongFloatPair extends LongFloatPair {
    ...
    /**
     * Obtains an immutable pair of the given {@code long} and {@code float} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static ImmutableLongFloatPair of(long left, float right) {
        return new ImmutableLongFloatPair(left, right);
    }
     ...
     */
    public ImmutableLongFloatPair(long left, float right) {
        this.left = left;
        this.right = right;
    }
