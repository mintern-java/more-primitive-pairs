 ...
 * {@code double} and a {@code float} element that allows users to avoid {@code Double} and
 * {@code Float} boxing. It refers to the elements as 'left' and 'right'.
 * <p>
...
public abstract class DoubleFloatPair implements PrimitivePair<Double, Float>, Comparable<DoubleFloatPair> {
    ...
    public static DoubleFloatPair of(double left, float right) {
        return ImmutableDoubleFloatPair.of(left, right);
    }
