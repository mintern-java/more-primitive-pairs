...
/**
 * An immutable pair consisting of an {@code int} element and a {@code float} element, providing a
 * version of {@link ImmutablePair} that avoids unnecessary {@code Integer} and {@code Float}
 * boxing.
 * <p>
...
public final class ImmutableIntFloatPair extends IntFloatPair {
    ...
    /**
     * Obtains an immutable pair of the given {@code int} and {@code float} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static ImmutableIntFloatPair of(int left, float right) {
        return new ImmutableIntFloatPair(left, right);
    }
     ...
     */
    public ImmutableIntFloatPair(int left, float right) {
        this.left = left;
        this.right = right;
    }
