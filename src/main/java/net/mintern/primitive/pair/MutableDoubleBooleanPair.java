...
/**
 * A mutable pair consisting of a {@code double} element and an {@code boolean} element, providing a
 * version of {@link MutablePair} that avoids unnecessary {@code Double} and {@code Boolean}
 * boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableDoubleBooleanPair extends DoubleBooleanPair {
    ...
    /**
     * Obtains a mutable pair of the given {@code double} and {@code boolean} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static MutableDoubleBooleanPair of(double left, boolean right) {
        return new MutableDoubleBooleanPair(left, right);
    }
     ...
     */
    public MutableDoubleBooleanPair(double left, boolean right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<Double, Boolean> boxed() {
