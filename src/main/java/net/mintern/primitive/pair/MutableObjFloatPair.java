...
/**
 * A mutable pair consisting of an {@code Object} element and a {@code float} element, providing a
 * version of {@link MutablePair} that avoids unnecessary {@code Float} boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableObjFloatPair<L> extends ObjFloatPair<L> {
    ...
    /**
     * Obtains a mutable pair of the given {@code Object} and {@code float} values.
     *
     * @param <L> the left element type
     ...
     */
    public static <L> MutableObjFloatPair<L> of(L left, float right) {
        return new MutableObjFloatPair<>(left, right);
    }
     ...
     */
    public MutableObjFloatPair(L left, float right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<L, Float> boxed() {
