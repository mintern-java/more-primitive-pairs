...
/**
 * A mutable pair consisting of an {@code char} element and a {@code long} element, providing a
 * version of {@link MutablePair} that avoids unnecessary {@code Character} and {@code Long} boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableCharLongPair extends CharLongPair {
    ...
    /**
     * Obtains a mutable pair of the given {@code char} and {@code long} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static MutableCharLongPair of(char left, long right) {
        return new MutableCharLongPair(left, right);
    }
     ...
     */
    public MutableCharLongPair(char left, long right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<Character, Long> boxed() {
