...
/**
 * A mutable pair consisting of a {@code long} element and an {@code char} element, providing a
 * version of {@link MutablePair} that avoids unnecessary {@code Long} and {@code Character} boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableLongCharPair extends LongCharPair {
    ...
    /**
     * Obtains a mutable pair of the given {@code long} and {@code char} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static MutableLongCharPair of(long left, char right) {
        return new MutableLongCharPair(left, right);
    }
     ...
     */
    public MutableLongCharPair(long left, char right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<Long, Character> boxed() {
