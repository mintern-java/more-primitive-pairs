...
/**
 * An immutable pair consisting of an {@code char} element and a {@code byte} element, providing a
 * version of {@link ImmutablePair} that avoids unnecessary {@code Character} and {@code Byte}
 * boxing.
 * <p>
...
public final class ImmutableCharBytePair extends CharBytePair {
    ...
    /**
     * Obtains an immutable pair of the given {@code char} and {@code byte} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static ImmutableCharBytePair of(char left, byte right) {
        return new ImmutableCharBytePair(left, right);
    }
     ...
     */
    public ImmutableCharBytePair(char left, byte right) {
        this.left = left;
        this.right = right;
    }
