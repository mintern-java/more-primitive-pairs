...
/**
 * An immutable pair consisting of {@code boolean} elements, providing a version of
 * {@link ImmutablePair} that avoids unnecessary {@code Boolean} boxing.
 * <p>
...
public final class ImmutableBooleanPair extends BooleanPair {
     ...
     */
    public static  ImmutableBooleanPair of(boolean left, boolean right) {
        return new ImmutableBooleanPair(left, right);
    }
     ...
     */
    public ImmutableBooleanPair(boolean left, boolean right) {
        this.left = left;
        this.right = right;
    }
