...
/**
 * An immutable pair consisting of {@code char} elements, providing a version of
 * {@link ImmutablePair} that avoids unnecessary {@code Character} boxing.
 * <p>
 ...
 */
public final class ImmutableCharPair extends CharPair {
     ...
     */
    public static  ImmutableCharPair of(char left, char right) {
        return new ImmutableCharPair(left, right);
    }
     ...
     */
    public ImmutableCharPair(char left, char right) {
        this.left = left;
        this.right = right;
    }
