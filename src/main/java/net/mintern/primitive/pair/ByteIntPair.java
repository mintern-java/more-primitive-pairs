...
/**
 * A pair modeled after {@link org.apache.commons.lang3.tuple.Pair} that consists of a {@code byte}
 * and a {@code int} element that allows users to avoid {@code Byte} and {@code Integer} boxing. It
 ...
 */
public abstract class ByteIntPair implements PrimitivePair<Byte, Integer>, Comparable<ByteIntPair> {
    ...
    public static ByteIntPair of(byte left, int right) {
        return ImmutableByteIntPair.of(left, right);
    }
