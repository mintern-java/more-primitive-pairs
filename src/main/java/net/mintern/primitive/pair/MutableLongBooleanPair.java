...
/**
 * A mutable pair consisting of a {@code long} element and an {@code boolean} element, providing a
 * version of {@link MutablePair} that avoids unnecessary {@code Long} and {@code Boolean} boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableLongBooleanPair extends LongBooleanPair {
    ...
    /**
     * Obtains a mutable pair of the given {@code long} and {@code boolean} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static MutableLongBooleanPair of(long left, boolean right) {
        return new MutableLongBooleanPair(left, right);
    }
     ...
     */
    public MutableLongBooleanPair(long left, boolean right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<Long, Boolean> boxed() {
