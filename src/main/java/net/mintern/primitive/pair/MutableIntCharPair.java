...
/**
 * A mutable pair consisting of an {@code int} element and a {@code char} element, providing a
 * version of {@link MutablePair} that avoids unnecessary {@code Integer} and {@code Character}
 * boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableIntCharPair extends IntCharPair {
    ...
    /**
     * Obtains a mutable pair of the given {@code int} and {@code char} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static MutableIntCharPair of(int left, char right) {
        return new MutableIntCharPair(left, right);
    }
     ...
     */
    public MutableIntCharPair(int left, char right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<Integer, Character> boxed() {
