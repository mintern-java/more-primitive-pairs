...
/**
 * A mutable pair consisting of an {@code int} element and a {@code byte} element, providing a
 * version of {@link MutablePair} that avoids unnecessary {@code Integer} and {@code Byte} boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableIntBytePair extends IntBytePair {
    ...
    /**
     * Obtains a mutable pair of the given {@code int} and {@code byte} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static MutableIntBytePair of(int left, byte right) {
        return new MutableIntBytePair(left, right);
    }
     ...
     */
    public MutableIntBytePair(int left, byte right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<Integer, Byte> boxed() {
