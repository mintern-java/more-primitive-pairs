...
/**
 * A pair modeled after {@link org.apache.commons.lang3.tuple.Pair} that consists of {@code float}
 * elements that allows users to avoid {@code Float} boxing. It refers to the elements as 'left'
 * and 'right'.
 * <p>
...
public abstract class FloatPair implements PrimitivePair<Float, Float>, Comparable<FloatPair> {
    ...
    /**
     * Obtains an immutable pair of the given {@code float} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static  FloatPair of(float left, float right) {
        return ImmutableFloatPair.of(left, right);
    }
     ...
     */
    @Override
    public int compareTo(FloatPair other) {
