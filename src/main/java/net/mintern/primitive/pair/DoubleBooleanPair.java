 ...
 * {@code double} and a {@code boolean} element that allows users to avoid {@code Double} and
 * {@code Boolean} boxing. It refers to the elements as 'left' and 'right'.
 * <p>
...
public abstract class DoubleBooleanPair implements PrimitivePair<Double, Boolean>, Comparable<DoubleBooleanPair> {
    ...
    public static DoubleBooleanPair of(double left, boolean right) {
        return ImmutableDoubleBooleanPair.of(left, right);
    }
