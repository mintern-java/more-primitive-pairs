...
/**
 * A mutable pair consisting of an {@code int} element and a {@code boolean} element, providing a
 * version of {@link MutablePair} that avoids unnecessary {@code Integer} and {@code Boolean}
 * boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableIntBooleanPair extends IntBooleanPair {
    ...
    /**
     * Obtains a mutable pair of the given {@code int} and {@code boolean} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static MutableIntBooleanPair of(int left, boolean right) {
        return new MutableIntBooleanPair(left, right);
    }
     ...
     */
    public MutableIntBooleanPair(int left, boolean right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<Integer, Boolean> boxed() {
