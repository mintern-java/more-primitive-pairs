 ...
 * {@code float} and an {@code char} element that allows users to avoid {@code Float} and
 * {@code Character} boxing. It refers to the elements as 'left' and 'right'.
 * <p>
...
public abstract class FloatCharPair implements PrimitivePair<Float, Character>, Comparable<FloatCharPair> {
    ...
    public static FloatCharPair of(float left, char right) {
        return ImmutableFloatCharPair.of(left, right);
    }
