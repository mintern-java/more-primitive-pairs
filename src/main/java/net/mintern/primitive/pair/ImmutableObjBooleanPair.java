...
/**
 * An immutable pair consisting of an {@code Object} and a {@code boolean} element, providing a
 * version of {@link ImmutablePair} that avoids unnecessary {@code Boolean} boxing.
 * <p>
...
public final class ImmutableObjBooleanPair<L> extends ObjBooleanPair<L> {
    ...
    /**
     * Obtains an immutable pair of the given {@code Object} and {@code boolean} values.
     *
     * @param <L> the left element type
     ...
     */
    public static <L> ImmutableObjBooleanPair<L> of(L left, boolean right) {
        return new ImmutableObjBooleanPair<>(left, right);
    }
     ...
     */
    public ImmutableObjBooleanPair(L left, boolean right) {
        this.left = left;
        this.right = right;
    }
