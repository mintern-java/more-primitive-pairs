 ...
 * {@code boolean} and a {@code long} element that allows users to avoid {@code Boolean} and
 * {@code Long} boxing. It refers to the elements as 'left' and 'right'.
 * <p>
...
public abstract class BooleanLongPair implements PrimitivePair<Boolean, Long>, Comparable<BooleanLongPair> {
    ...
    public static BooleanLongPair of(boolean left, long right) {
        return ImmutableBooleanLongPair.of(left, right);
    }
