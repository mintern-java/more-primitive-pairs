...
/**
 * A mutable pair consisting of a {@code double} element and a {@code float} element, providing a
 * version of {@link MutablePair} that avoids unnecessary {@code Double} and {@code Float} boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableDoubleFloatPair extends DoubleFloatPair {
    ...
    /**
     * Obtains a mutable pair of the given {@code double} and {@code float} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static MutableDoubleFloatPair of(double left, float right) {
        return new MutableDoubleFloatPair(left, right);
    }
     ...
     */
    public MutableDoubleFloatPair(double left, float right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<Double, Float> boxed() {
