...
/**
 * A mutable pair consisting of a {@code float} element and an {@code byte} element, providing a
 * version of {@link MutablePair} that avoids unnecessary {@code Float} and {@code Byte}
 * boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableFloatBytePair extends FloatBytePair {
    ...
    /**
     * Obtains a mutable pair of the given {@code float} and {@code byte} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static MutableFloatBytePair of(float left, byte right) {
        return new MutableFloatBytePair(left, right);
    }
     ...
     */
    public MutableFloatBytePair(float left, byte right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<Float, Byte> boxed() {
