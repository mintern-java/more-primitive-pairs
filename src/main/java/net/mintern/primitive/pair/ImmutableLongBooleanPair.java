...
/**
 * An immutable pair consisting of a {@code long} element and an {@code boolean} element, providing
 * a version of {@link ImmutablePair} that avoids unnecessary {@code Long} and {@code Boolean}
 * boxing.
 * <p>
...
public final class ImmutableLongBooleanPair extends LongBooleanPair {
    ...
    /**
     * Obtains an immutable pair of the given {@code long} and {@code boolean} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static ImmutableLongBooleanPair of(long left, boolean right) {
        return new ImmutableLongBooleanPair(left, right);
    }
     ...
     */
    public ImmutableLongBooleanPair(long left, boolean right) {
        this.left = left;
        this.right = right;
    }
