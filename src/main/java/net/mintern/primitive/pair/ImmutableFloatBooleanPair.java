...
/**
 * An immutable pair consisting of a {@code float} element and a {@code boolean} element, providing
 * a version of {@link ImmutablePair} that avoids unnecessary {@code Float} and {@code Boolean}
 * boxing.
 * <p>
...
public final class ImmutableFloatBooleanPair extends FloatBooleanPair {
    ...
    /**
     * Obtains an immutable pair of the given {@code float} and {@code boolean} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static ImmutableFloatBooleanPair of(float left, boolean right) {
        return new ImmutableFloatBooleanPair(left, right);
    }
     ...
     */
    public ImmutableFloatBooleanPair(float left, boolean right) {
        this.left = left;
        this.right = right;
    }
