...
/**
 * A mutable pair consisting of a {@code double} element and an {@code byte} element, providing a
 * version of {@link MutablePair} that avoids unnecessary {@code Double} and {@code Byte}
 * boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableDoubleBytePair extends DoubleBytePair {
    ...
    /**
     * Obtains a mutable pair of the given {@code double} and {@code byte} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static MutableDoubleBytePair of(double left, byte right) {
        return new MutableDoubleBytePair(left, right);
    }
     ...
     */
    public MutableDoubleBytePair(double left, byte right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<Double, Byte> boxed() {
