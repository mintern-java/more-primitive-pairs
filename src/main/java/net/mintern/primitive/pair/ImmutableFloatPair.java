...
/**
 * An immutable pair consisting of {@code float} elements, providing a version of
 * {@link ImmutablePair} that avoids unnecessary {@code Float} boxing.
 * <p>
 ...
 */
public final class ImmutableFloatPair extends FloatPair {
     ...
     */
    public static  ImmutableFloatPair of(float left, float right) {
        return new ImmutableFloatPair(left, right);
    }
