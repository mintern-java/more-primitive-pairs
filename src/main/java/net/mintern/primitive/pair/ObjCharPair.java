 ...
 * {@code Object} and an {@code char} element that allows users to avoid {@code Character} boxing.
...
public abstract class ObjCharPair<L> implements PrimitivePair<L, Character>, Comparable<ObjCharPair<L>> {
     ...
     */
    public static <L> ObjCharPair<L> of(L left, char right) {
        return ImmutableObjCharPair.of(left, right);
    }
     ...
     */
    @Override
    public int compareTo(ObjCharPair<L> other) {
