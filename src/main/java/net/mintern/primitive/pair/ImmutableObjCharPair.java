...
/**
 * An immutable pair consisting of an {@code Object} and an {@code char} element, providing a version
 * of {@link ImmutablePair} that avoids unnecessary {@code Character} boxing.
 * <p>
...
public final class ImmutableObjCharPair<L> extends ObjCharPair<L> {
    ...
    /**
     * Obtains an immutable pair of the given {@code Object} and {@code char} values.
     *
     * @param <L> the left element type
     ...
     */
    public static <L> ImmutableObjCharPair<L> of(L left, char right) {
        return new ImmutableObjCharPair<>(left, right);
    }
     ...
     */
    public ImmutableObjCharPair(L left, char right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public ImmutablePair<L, Character> boxed() {
