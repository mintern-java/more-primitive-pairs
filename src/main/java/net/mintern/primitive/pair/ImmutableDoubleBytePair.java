...
/**
 * An immutable pair consisting of a {@code double} element and a {@code byte} element, providing a
 * version of {@link ImmutablePair} that avoids unnecessary {@code Double} and {@code Byte} boxing.
 * <p>
...
public final class ImmutableDoubleBytePair extends DoubleBytePair {
     ...
     */
    public static ImmutableDoubleBytePair of(double left, byte right) {
        return new ImmutableDoubleBytePair(left, right);
    }
     ...
     */
    public ImmutableDoubleBytePair(double left, byte right) {
        this.left = left;
        this.right = right;
    }
