...
/**
 * A pair modeled after {@link org.apache.commons.lang3.tuple.Pair} that consists of {@code byte}
 * elements that allows users to avoid {@code Byte} boxing. It refers to the elements as 'left'
 * and 'right'.
 * <p>
...
public abstract class BytePair implements PrimitivePair<Byte, Byte>, Comparable<BytePair> {
     ...
     */
    public static  BytePair of(byte left, byte right) {
        return ImmutableBytePair.of(left, right);
    }
