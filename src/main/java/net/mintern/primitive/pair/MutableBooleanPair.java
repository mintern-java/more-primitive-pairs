...
/**
 * A mutable pair consisting of {@code boolean} elements, providing a version of {@link MutablePair}
 * that avoids unnecessary {@code Boolean} boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableBooleanPair extends BooleanPair {
    ...
    /**
     * Obtains a mutable pair of the given {@code boolean} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static MutableBooleanPair of(boolean left, boolean right) {
        return new MutableBooleanPair(left, right);
    }
     ...
     */
    public MutableBooleanPair(boolean left, boolean right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<Boolean, Boolean> boxed() {
