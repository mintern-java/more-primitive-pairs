...
/**
 * A mutable pair consisting of {@code char} elements, providing a version of {@link MutablePair}
 * that avoids unnecessary {@code Character} boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableCharPair extends CharPair {
    ...
    /**
     * Obtains a mutable pair of the given {@code char} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static MutableCharPair of(char left, char right) {
        return new MutableCharPair(left, right);
    }
     ...
     */
    public MutableCharPair(char left, char right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<Character, Character> boxed() {
