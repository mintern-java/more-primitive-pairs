...
/**
 * A mutable pair consisting of an {@code int} element and a {@code float} element, providing a
 * version of {@link MutablePair} that avoids unnecessary {@code Integer} and {@code Float} boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableIntFloatPair extends IntFloatPair {
    ...
    /**
     * Obtains a mutable pair of the given {@code int} and {@code float} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static MutableIntFloatPair of(int left, float right) {
        return new MutableIntFloatPair(left, right);
    }
     ...
     */
    public MutableIntFloatPair(int left, float right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<Integer, Float> boxed() {
