...
/**
 * An immutable pair consisting of a {@code double} element and a {@code boolean} element, providing
 * a version of {@link ImmutablePair} that avoids unnecessary {@code Double} and {@code Boolean}
 * boxing.
 * <p>
...
public final class ImmutableDoubleBooleanPair extends DoubleBooleanPair {
    ...
    /**
     * Obtains an immutable pair of the given {@code double} and {@code boolean} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static ImmutableDoubleBooleanPair of(double left, boolean right) {
        return new ImmutableDoubleBooleanPair(left, right);
    }
     ...
     */
    public ImmutableDoubleBooleanPair(double left, boolean right) {
        this.left = left;
        this.right = right;
    }
