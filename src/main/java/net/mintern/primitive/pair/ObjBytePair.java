 ...
 * {@code Object} and a {@code byte} element that allows users to avoid {@code Byte} boxing. It
...
public abstract class ObjBytePair<L> implements PrimitivePair<L, Byte>, Comparable<ObjBytePair<L>> {
     ...
     */
    public static <L> ObjBytePair<L> of(L left, byte right) {
        return ImmutableObjBytePair.of(left, right);
    }
     ...
     */
    @Override
    public int compareTo(ObjBytePair<L> other) {
