...
/**
 * An immutable pair consisting of an {@code Object} and a {@code float} element, providing a
 * version of {@link ImmutablePair} that avoids unnecessary {@code Float} boxing.
 * <p>
...
public final class ImmutableObjFloatPair<L> extends ObjFloatPair<L> {
    ...
    /**
     * Obtains an immutable pair of the given {@code Object} and {@code float} values.
     *
     * @param <L> the left element type
     ...
     */
    public static <L> ImmutableObjFloatPair<L> of(L left, float right) {
        return new ImmutableObjFloatPair<>(left, right);
    }
     ...
     */
    public ImmutableObjFloatPair(L left, float right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public ImmutablePair<L, Float> boxed() {
