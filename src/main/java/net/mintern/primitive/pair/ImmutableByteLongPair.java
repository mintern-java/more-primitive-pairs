...
/**
 * An immutable pair consisting of a {@code byte} element and a {@code long} element, providing a
 * version of {@link ImmutablePair} that avoids unnecessary {@code Byte} and {@code Long} boxing.
 * <p>
...
public final class ImmutableByteLongPair extends ByteLongPair {
    ...
    /**
     * Obtains an immutable pair of the given {@code byte} and {@code long} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static ImmutableByteLongPair of(byte left, long right) {
        return new ImmutableByteLongPair(left, right);
    }
     ...
     */
    public ImmutableByteLongPair(byte left, long right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public ImmutablePair<Byte, Long> boxed() {
