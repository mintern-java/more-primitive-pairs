...
/**
 * A mutable pair consisting of a {@code byte} element and an {@code boolean} element, providing a
 * version of {@link MutablePair} that avoids unnecessary {@code Byte} and {@code Boolean}
 * boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableByteBooleanPair extends ByteBooleanPair {
    ...
    /**
     * Obtains a mutable pair of the given {@code byte} and {@code boolean} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static MutableByteBooleanPair of(byte left, boolean right) {
        return new MutableByteBooleanPair(left, right);
    }
     ...
     */
    public MutableByteBooleanPair(byte left, boolean right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<Byte, Boolean> boxed() {
