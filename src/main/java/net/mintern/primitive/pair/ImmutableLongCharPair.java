...
/**
 * An immutable pair consisting of a {@code long} element and an {@code char} element, providing a
 * version of {@link ImmutablePair} that avoids unnecessary {@code Long} and {@code Character}
 * boxing.
 * <p>
...
public final class ImmutableLongCharPair extends LongCharPair {
    ...
    /**
     * Obtains an immutable pair of the given {@code long} and {@code char} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static ImmutableLongCharPair of(long left, char right) {
        return new ImmutableLongCharPair(left, right);
    }
     ...
     */
    public ImmutableLongCharPair(long left, char right) {
        this.left = left;
        this.right = right;
    }
