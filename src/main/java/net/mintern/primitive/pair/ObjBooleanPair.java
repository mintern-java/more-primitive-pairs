 ...
 * {@code Object} and a {@code boolean} element that allows users to avoid {@code Boolean} boxing.
...
public abstract class ObjBooleanPair<L> implements PrimitivePair<L, Boolean>, Comparable<ObjBooleanPair<L>> {
     ...
     */
    public static <L> ObjBooleanPair<L> of(L left, boolean right) {
        return ImmutableObjBooleanPair.of(left, right);
    }
     ...
     */
    @Override
    public int compareTo(ObjBooleanPair<L> other) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ObjBooleanPair<?>) {
            ObjBooleanPair<?> o = (ObjBooleanPair<?>) obj;
