...
/**
 * An immutable pair consisting of a {@code boolean} element and a {@code long} element, providing a
 * version of {@link ImmutablePair} that avoids unnecessary {@code Boolean} and {@code Long} boxing.
 * <p>
...
public final class ImmutableBooleanLongPair extends BooleanLongPair {
    ...
    /**
     * Obtains an immutable pair of the given {@code boolean} and {@code long} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static ImmutableBooleanLongPair of(boolean left, long right) {
        return new ImmutableBooleanLongPair(left, right);
    }
     ...
     */
    public ImmutableBooleanLongPair(boolean left, long right) {
        this.left = left;
        this.right = right;
    }
