 ...
 * {@code char} and a {@code long} element that allows users to avoid {@code Character} and
...
public abstract class CharLongPair implements PrimitivePair<Character, Long>, Comparable<CharLongPair> {
    ...
    public static CharLongPair of(char left, long right) {
        return ImmutableCharLongPair.of(left, right);
    }
     ...
     */
    @Override
    public int compareTo(CharLongPair other) {
