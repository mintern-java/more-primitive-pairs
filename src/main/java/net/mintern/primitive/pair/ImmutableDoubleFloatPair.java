...
/**
 * An immutable pair consisting of a {@code double} element and a {@code float} element, providing a
 * version of {@link ImmutablePair} that avoids unnecessary {@code Double} and {@code Float} boxing.
 * <p>
...
public final class ImmutableDoubleFloatPair extends DoubleFloatPair {
    ...
    /**
     * Obtains an immutable pair of the given {@code double} and {@code float} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static ImmutableDoubleFloatPair of(double left, float right) {
        return new ImmutableDoubleFloatPair(left, right);
    }
     ...
     */
    public ImmutableDoubleFloatPair(double left, float right) {
        this.left = left;
        this.right = right;
    }
