...
/**
 * A mutable pair consisting of a {@code boolean} element and an {@code int} element, providing a
 * version of {@link MutablePair} that avoids unnecessary {@code Boolean} and {@code Integer}
 * boxing.
 * <p>
 * Not #ThreadSafe#
 *
...
public class MutableBooleanIntPair extends BooleanIntPair {
    ...
    /**
     * Obtains a mutable pair of the given {@code boolean} and {@code int} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static MutableBooleanIntPair of(boolean left, int right) {
        return new MutableBooleanIntPair(left, right);
    }
     ...
     */
    public MutableBooleanIntPair(boolean left, int right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public MutablePair<Boolean, Integer> boxed() {
