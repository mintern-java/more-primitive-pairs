...
/**
 * An immutable pair consisting of a {@code float} element and a {@code byte} element, providing a
 * version of {@link ImmutablePair} that avoids unnecessary {@code Float} and {@code Byte} boxing.
 * <p>
...
public final class ImmutableFloatBytePair extends FloatBytePair {
    ...
    /**
     * Obtains an immutable pair of the given {@code float} and {@code byte} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static ImmutableFloatBytePair of(float left, byte right) {
        return new ImmutableFloatBytePair(left, right);
    }
     ...
     */
    public ImmutableFloatBytePair(float left, byte right) {
        this.left = left;
        this.right = right;
    }
