...
/**
 * An immutable pair consisting of a {@code byte} element and a {@code boolean} element, providing
 * a version of {@link ImmutablePair} that avoids unnecessary {@code Byte} and {@code Boolean}
 * boxing.
 * <p>
...
public final class ImmutableByteBooleanPair extends ByteBooleanPair {
    ...
    /**
     * Obtains an immutable pair of the given {@code byte} and {@code boolean} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static ImmutableByteBooleanPair of(byte left, boolean right) {
        return new ImmutableByteBooleanPair(left, right);
    }
     ...
     */
    public ImmutableByteBooleanPair(byte left, boolean right) {
        this.left = left;
        this.right = right;
    }
