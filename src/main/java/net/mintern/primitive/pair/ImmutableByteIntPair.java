...
/**
 * An immutable pair consisting of a {@code byte} element and a {@code int} element, providing a
 * version of {@link ImmutablePair} that avoids unnecessary {@code Byte} and {@code Integer}
 * boxing.
 * <p>
...
public final class ImmutableByteIntPair extends ByteIntPair {
    ...
    /**
     * Obtains an immutable pair of the given {@code byte} and {@code int} values.
     *
     * @param left  the left element
     * @param right  the right element
     * @return a pair formed from the two parameters, not null
     */
    public static ImmutableByteIntPair of(byte left, int right) {
        return new ImmutableByteIntPair(left, right);
    }
     ...
     */
    public ImmutableByteIntPair(byte left, int right) {
        this.left = left;
        this.right = right;
    }
    ...
    @Override
    public ImmutablePair<Byte, Integer> boxed() {
