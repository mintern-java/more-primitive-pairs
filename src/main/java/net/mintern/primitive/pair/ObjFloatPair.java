 ...
 * {@code Object} and a {@code float} element that allows users to avoid {@code Float} boxing. It
...
public abstract class ObjFloatPair<L> implements PrimitivePair<L, Float>, Comparable<ObjFloatPair<L>> {
     ...
     */
    public static <L> ObjFloatPair<L> of(L left, float right) {
        return ImmutableObjFloatPair.of(left, right);
    }
     ...
     */
    @Override
    public int compareTo(ObjFloatPair<L> other) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ObjFloatPair<?>) {
            ObjFloatPair<?> o = (ObjFloatPair<?>) obj;
