...
/**
 * A pair modeled after {@link org.apache.commons.lang3.tuple.Pair} that consists of a {@code float}
 * and a {@code int} element that allows users to avoid {@code Float} and {@code Integer} boxing. It
...
public abstract class FloatIntPair implements PrimitivePair<Float, Integer>, Comparable<FloatIntPair> {
    ...
    public static FloatIntPair of(float left, int right) {
        return ImmutableFloatIntPair.of(left, right);
    }
